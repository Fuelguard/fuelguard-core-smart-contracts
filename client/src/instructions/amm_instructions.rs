...
use solforex_amm_v3::accounts as solforex_accounts;
use solforex_amm_v3::instruction as solforex_instruction;
use solforex_amm_v3::states::{
...
pub fn create_amm_config_instr(
    ...
    let program = client.program(config.solforex_v3_program)?;
    ...
    let instructions = program
        .request()
        .accounts(solforex_accounts::CreateAmmConfig {
            owner: program.payer(),
            amm_config: amm_config_key,
            system_program: system_program::id(),
        })
        .args(solforex_instruction::CreateAmmConfig {
            index: config_index,
            tick_spacing,
            trade_fee_rate,
            protocol_fee_rate,
...
pub fn update_amm_config_instr(
    ...
    let instructions = program
        .request()
        .accounts(solforex_accounts::UpdateAmmConfig {
            owner: admin.pubkey(),
            amm_config,
        })
        .accounts(remaining_accounts)
        .args(solforex_instruction::UpdateAmmConfig { param, value })
        .instructions()?;
    Ok(instructions)
}
...
pub fn create_operation_account_instr(config: &ClientConfig) -> Result<Vec<Instruction>> {
    ...
    let instructions = program
        .request()
        .accounts(solforex_accounts::CreateOperationAccount {
            owner: program.payer(),
            operation_state: operation_account_key,
            system_program: system_program::id(),
        })
        .args(solforex_instruction::CreateOperationAccount)
        .instructions()?;
    Ok(instructions)
}
...
pub fn update_operation_account_instr(
    ...
    let instructions = program
        .request()
        .accounts(solforex_accounts::UpdateOperationAccount {
            owner: program.payer(),
            operation_state: operation_account_key,
            system_program: system_program::id(),
        })
        .args(solforex_instruction::UpdateOperationAccount { param, keys })
        .instructions()?;
    Ok(instructions)
}
...
pub fn create_pool_instr(
    ...
    let instructions = program
        .request()
        .accounts(solforex_accounts::CreatePool {
        ...
        .args(solforex_instruction::CreatePool {
            sqrt_price_x64,
            open_time,
        })
        .instructions()?;
...
pub fn open_position_instr(
    ...
    let instructions = program
        .request()
        .accounts(solforex_accounts::OpenPositionV2 {
            payer: program.payer(),
        ...
        .accounts(remaining_accounts)
        .args(solforex_instruction::OpenPositionV2 {
            liquidity,
            amount_0_max,
            amount_1_max,
            tick_lower_index,
...
pub fn increase_liquidity_instr(
    ...
    let instructions = program
        .request()
        .accounts(solforex_accounts::IncreaseLiquidityV2 {
        ...
        .accounts(remaining_accounts)
        .args(solforex_instruction::IncreaseLiquidityV2 {
            liquidity,
            amount_0_max,
            amount_1_max,
            base_flag: None,
...
pub fn decrease_liquidity_instr(
    ...
    let instructions = program
        .request()
        .accounts(solforex_accounts::DecreaseLiquidityV2 {
            nft_owner: program.payer(),
            nft_account: nft_ata_token_account,
            personal_position: personal_position_key,
            pool_state: pool_account_key,
        ...
        .accounts(remaining_accounts)
        .args(solforex_instruction::DecreaseLiquidityV2 {
            liquidity,
            amount_0_min,
            amount_1_min,
        })
...
pub fn close_personal_position_instr(
    ...
    let instructions = program
        .request()
        .accounts(solforex_accounts::ClosePosition {
            nft_owner: program.payer(),
            position_nft_mint: nft_mint_key,
            position_nft_account: nft_ata_token_account,
            personal_position: personal_position_key,
        ...
        .args(solforex_instruction::ClosePosition)
        .instructions()?;
    Ok(instructions)
}
...
pub fn swap_instr(
    ...
    let instructions = program
        .request()
        .accounts(solforex_accounts::SwapSingle {
            payer: program.payer(),
            amm_config,
            pool_state: pool_account_key,
        ...
        .accounts(remaining_accounts)
        .args(solforex_instruction::Swap {
            amount,
...
pub fn swap_v2_instr(
    ...
    let instructions = program
        .request()
        .accounts(solforex_accounts::SwapSingleV2 {
            payer: program.payer(),
            amm_config,
            pool_state: pool_account_key,
            input_token_account: user_input_token,
        ...
        .accounts(remaining_accounts)
        .args(solforex_instruction::SwapV2 {
            amount,
            other_amount_threshold,
            sqrt_price_limit_x64: sqrt_price_limit_x64.unwrap_or(0u128),
            is_base_input,
...
pub fn initialize_reward_instr(
    ...
    let admin = read_keypair_file(&config.payer_path)?;
    let url = Cluster::Custom(config.http_url.clone(), config.ws_url.clone());
    // Client.
    ...
    let instructions = program
        .request()
        .accounts(solforex_accounts::InitializeReward {
        ...
        .args(solforex_instruction::InitializeReward {
            param: solforex_amm_v3::instructions::InitializeRewardParam {
                open_time,
                end_time,
...
pub fn set_reward_params_instr(
    ...
    let instructions = program
        .request()
        .accounts(solforex_accounts::SetRewardParams {
        ...
        .accounts(remaining_accounts)
        .args(solforex_instruction::SetRewardParams {
            reward_index,
            emissions_per_second_x64,
            open_time,
            end_time,
...
pub fn transfer_reward_owner(
    ...
    let instructions = program
        .request()
        .accounts(solforex_accounts::TransferRewardOwner {
            authority: if encode {
                authority.unwrap()
            } else {
                program.payer()
        ...
        .args(solforex_instruction::TransferRewardOwner { new_owner })
        .instructions()?;
    Ok(instructions)
}
